...
interface IBag {
    ...
    /// @notice Emitted when a Bag token is bought
    ...
    /// @notice Emitted when a Bag token is sold
    ...
    /// @notice Emitted when Bag tokens are transferred
    ...
    /// @notice Emiitted when graduation fee is updated
    /// @param oldFee The old graduation fee
    /// @param newFee The new graduation fee
    event GraduationFeeUpdated(
        uint256 oldFee,
        uint256 newFee
    );
    /// @notice Emitted when contract parameters are updated
    /// @param _maxSupply Max total supply of the token
    /// @param _primarySupply Primary supply of the token
    /// @param _secondarySupply Secondary supply of the token
    ...
    /// @dev Emits a BagTokenTransfer event with the updated token balances and total supply
